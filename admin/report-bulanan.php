        ...
        <div class="table-responsive">
          <table class="table table-hover" id="table-report" width="100%">
            ...
            <tbody align="center">
              <?php
              if ($_POST['month'] == '') {
                echo "<script>alert('Anda belum menentukan bulan'); window.location='filter.php';</script>";
              } else if ($_POST['year'] == '') {
                echo "<script>alert('Anda belum menentukan tahun'); window.location='filter.php';</script>";
              } else {
                $month = $_POST['month'];
                $year = $_POST['year'];
