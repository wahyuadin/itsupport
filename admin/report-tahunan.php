        ...
        <div class="table-responsive">
          <table class="table table-hover" id="table-report" width="100%">
            ...
            <tbody align="center">
              <?php
              if ($_POST['year1'] == '') {
                echo "<script>alert('Anda belum menentukan tahun awal'); window.location='filter.php';</script>";
              } else if ($_POST['year2'] == '') {
                echo "<script>alert('Anda belum menentukan tahun akhir'); window.location='filter.php';</script>";
              } else {
                $year1 = $_POST['year1'];
                $year2 = $_POST['year2'];
